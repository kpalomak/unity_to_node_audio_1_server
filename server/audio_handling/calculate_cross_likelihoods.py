...
for word_name in word_names:
	...
	for wav_name in wav_names:
		...
		cmd_test = './shell_script_aligner.sh ' + word_name + ' ' + lex_name + ' ' + wav_name +  ' label_test ' + model_name + ' ' + word_name + '_test.phn' + ' >& tmp_test.txt'
		sys.stderr.write(cmd_test + '\n')
		os.system(cmd_test)
		os.system('cat tmp_test.txt')
		word_obj = Word(word_name,audio_word_name,get_likelihood('tmp_test.txt'),wav_name)
