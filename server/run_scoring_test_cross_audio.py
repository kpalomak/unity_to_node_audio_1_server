...
#print wav_list
rounds=5
name_score_mat=subject_name + 'audio_score_mat_rounds_' + str(rounds)
...
if flag_run_analysis:
	for cnt_rounds in range(0,rounds):
		...
		for wav_name in wav_list:
			...
			cmd = "./audio_handling/audio_cross_likelihood_score.py " + target_word + " " + wav_name + " " + speaker_path + " " + adaptation_matrix_name + " " + str(flag_use_adaptation) + " " + lex_name
			print cmd
			ret=os.system(cmd)
			if not(ret==0):
				break
